...
public class TokenImportActivity extends Activity {
    ...
    private void setupEnterTokenScreen() {
        ...
        if (!mIsSecurid) {
            ...
            for (int r : resList) {
                findViewById(r).setVisibility(View.GONE);
            }
        }
        ...
        findViewById(R.id.token_string_clear).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void setupUnlockTokenScreen() {
        ...
        if (!mStoken.isDevIDRequired()) {
            findViewById(R.id.token_need_devid).setVisibility(View.GONE);
            findViewById(R.id.token_devid_entry).setVisibility(View.GONE);
            findViewById(R.id.token_devid_space).setVisibility(View.GONE);
        }
        if (!mStoken.isPassRequired()) {
            findViewById(R.id.token_need_password).setVisibility(View.GONE);
            findViewById(R.id.token_password_entry).setVisibility(View.GONE);
        }
    ...
    private void refreshProfileSelection(boolean updateText) {
        ...
        EditText entry = findViewById(R.id.new_vpn_hostname);
        TextView entryLabel = findViewById(R.id.new_vpn_label);

        Spinner sp = findViewById(R.id.vpn_spinner);
